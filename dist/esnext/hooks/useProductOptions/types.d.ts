...
export declare type SellingPlan = Omit<Partial<SellingPlanFragmentFragment>, 'id'> & {
    id: SellingPlanFragmentFragment['id'];
};
export declare type SellingPlanAllocation = Omit<Partial<VariantFragmentFragment['sellingPlanAllocations']['edges'][0]['node']>, 'sellingPlan'> & {
...
export declare type SelectOptionCallback = (name: VariantFragmentFragment['selectedOptions'][0]['name'], value: VariantFragmentFragment['selectedOptions'][0]['value']) => void;
export declare type SelectOptionsCallback = (options: SelectedOptions) => void;
export declare type OptionsInStockCallback = (name: VariantFragmentFragment['selectedOptions'][0]['name'], value: VariantFragmentFragment['selectedOptions'][0]['value']) => boolean;
export declare type SelectedSellingPlanCallback = (sellingPlan: SellingPlan) => void;
